...
case class NetcdfPartitionReaderFactory(schema: StructType,
                                        options: NetcdfDatasourceOptions) extends PartitionReaderFactory {
  private lazy val reader = new NetCdfFileReader(options.path)
